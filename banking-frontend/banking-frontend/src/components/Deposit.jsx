...
const Deposit = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const result = await accountAPI.deposit(payload);
      ...
      const message = err.response?.data?.message || 'Deposit failed. Please try again.';
      setError(message);
    } finally {
      setLoading(false);
    }
    ...
    <div className="fade-in">
      <div className="card" style={{ maxWidth: '720px', margin: '0 auto' }}>
        <div className="card-header">
          <h2>Deposit Money</h2>
          <p>Add funds to one of your bank accounts</p>
        </div>
        ...
        {!response ? (
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              />
              <small style={{ color: 'var(--text-light)', marginTop: '0.25rem' }}>
                Deposits are credited instantly and reflected in the account balance.
              </small>
            </div>
          ...
          <div className="fade-in">
            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div style={{ padding: '1rem', background: 'var(--light)', borderRadius: '8px', borderLeft: '4px solid var(--success)' }}>
                <p style={{ margin: '0 0 0.5rem 0', color: 'var(--text-light)', fontSize: '0.9rem' }}>Amount Deposited</p>
              ...
              {response.balance !== undefined && (
                <div style={{ padding: '1rem', background: 'var(--light)', borderRadius: '8px', borderLeft: '4px solid var(--primary)' }}>
                  <p style={{ margin: '0 0 0.5rem 0', color: 'var(--text-light)', fontSize: '0.9rem' }}>New Balance</p>
